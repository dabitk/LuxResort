...
<%
	...
	System.out.println("e_qnaReinsrt.jsp rootid: "+rootid+" relevel: "+relevel+" recnt: "+recnt);
      ...
      <div class="row">
		...
		<!-- 이곳에 공지사항 게시판을 추가한다. -->
			<div>
				...
				<table align=center width=100% cellspacing=1 border=1>
				<TR>
				<th>번호</th>
				<td>신규(insert)</td>		
				</TR>
				<TR>
				<th>제목</th>
				<td><input type="text" name="title" style="width:100%" maxlength="70" autocomplete=off required/></td>		
				</TR>			
				<TR>
				<th>일자</th>
				<td><script>getToday()</script></td>		
				</TR>
				<TR>
				<th>내용</th>
				<td>
					<textarea name="content" cols="80" rows="30" maxlength="1500" required>			
					</textarea>
					<script>
				...
				<span>
					<a href="e_02.jsp"><button type="button">취소</button></a>
					<input type='hidden' name='key' value='INSERT'/>
					<input type='hidden' name='relevel' value='<c:out value="${relevel+1}"/>'/>
					<input type='hidden' name='recnt' value='<c:out value="${recnt}"/>'/>
