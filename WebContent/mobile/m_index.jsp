...
function closeNav() {
  ...
  <div class="myVideo">
      <video autoplay loop muted style="width:100%">
         <source src="<%=request.getContextPath()%>/img/video/pvmovie.mp4" type="video/mp4">
      </video>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="<%=request.getContextPath()%>/img/room/r4.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="<%=request.getContextPath()%>/img/room/r8.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3>로열 스위트</h3>
		        <p>$800~</p>
		      </div>
		    ...
		    <div class="carousel-item">
		      <img src="<%=request.getContextPath()%>/img/room/r7.jpg" style="width:100%">
		      <div class="carousel-caption"> 
		        <h3>프리미어 디럭스</h3>
		        <p>$300~</p>
		      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">"2019년 WORLD TOURSITE TOP100 선정"</h3>
          
        </div>
      </div>
      <div class="row" style="display:inline-block">
         <span><img src="<%=request.getContextPath()%>/img/tour/grotto.jpg" style="width:100%"/></span>
      	 <span>
      	 	<p>대한민국 최남단에 위치한 럭셔리조트는 제주도의 아름다움과 열대지방의 이국적인 감각을 현대적인 감각으로 풀어낸 5성 호텔로 파노라믹한 스카이라인과 환상적인 야경을 조망할 수 있으며 일몰과 일출을 한 자리에서 감상할 수 있는 국내 최고의 고품격 5성 럭셔리 호텔입니다.</p>
      	 </span>
      </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">"제주도 유일의 미슐랭 3성 레스토랑이 선보이는 미식의 오케스트라"</h3>
        </div>
      </div>
      <div class="row" style="display:inline-block">
         <span><img style="width:100%"  src="<%=request.getContextPath()%>/img/tour/bbq.jpg"/></span>
      	 <span>
      	 	<p>대한민국 최남단에 위치한 럭셔리조트는 제주도의 아름다움과 열대지방의 이국적인 감각을 현대적인 감각으로 풀어낸 5성 호텔로 파노라믹한 스카이라인과 환상적인 야경을 조망할 수 있으며 일몰과 일출을 한 자리에서 감상할 수 있는 국내 최고의 고품격 5성 럭셔리 호텔입니다.</p>
      	 </span>         
      </div>      
      ...
      <div class="row" style="display:inline-block">
      	 <span>
      	 	<div style="display:table-row">
	      	 	<ul style="list-style-type:none; padding-inline-start:0px; display:flex; text-align:center">
	      	 		<li style="padding-left:1.2rem"><i class="fas fa-bus"></i> 버스<br>xxx-xxxx-xxxx-xxxx </li>
	      	 		<li style="padding-left:3rem"><i class="fas fa-taxi"></i> 자동차(렌터카/택시)<br>xxx-xxxx-xxxx-xxxx</li>
	      	 	</ul>
      	 	</div>
      	 </span>
