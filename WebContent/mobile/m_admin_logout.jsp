...
<head>
  ...
  <meta charset="utf-8">
  <META http-equiv="refresh" content="5;URL=<%=request.getContextPath()%>/mobile/m_index.jsp">
...
<%
	...
	//session.invalidate();
	session.setAttribute("login_ok", null);
	//로그아웃 후 리조트 홈페이지로 리다이렉트 시킨다.
%>
  <!-- Navigation -->
...
function closeNav() {
  ...
  <section class="page-section" id="services">
    ...
    <div class="centered">
    	<h1 style="margin-top:50px">관리자 로그아웃</h1>
    </div>
    <div class="container">
      <div class="row">
		...
		<!-- 이곳에 공지사항 게시판을 추가한다. -->
			<div>
				<h1 align=center><b>로그아웃 되었습니다.</b></h1>
				<p align=center>5초뒤 리조트 홈페이지로 리다이렉트 됩니다.</p>
				<span>
					<a class="btn btn-primary btn-lg rippler rippler-inverse" href="<%=request.getContextPath()%>/mobile/m_index.jsp">홈페이지로</a>
				</span>
			</div>
	        </div>
	      </div>
