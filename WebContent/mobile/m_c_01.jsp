		...
		<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" style="width:100%">
		  ...
		  <div class="carousel-inner" >
		    <div class="carousel-item active">
		      <img src="../img/facilities/scuba1.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="../img/facilities/scuba2.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
		    ...
		    <div class="carousel-item">
		      <img src="../img/facilities/scuba3.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
    ...
    <div class="container">
       <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" id="room_name">[ 스쿠버다이빙 체험 ]</h2>
          <h3 class="section-subheading text-muted">
			세계 최대 스쿠버 다이빙 교육기관인 PADI 인증을 받은 전문 강사들에 의해 초심자도 안심하고 해저의 모험을 즐기실 수 있습니다.<br>
			해저동굴, 침몰선, 열태 물고기와 사람 크기만한 바다거북이 등, 바다속의 모험으로 여러분을 모시겠습니다. 
		  </h3>
        </div>
      </div>
      <div class="row text-center">
