		...
		<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" style="width:100%">
		  ...
		  <div class="carousel-inner" >
		    <div class="carousel-item active">
		      <img src="../img/facilities/spa1.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="../img/facilities/spa2.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
		    ...
		    <div class="carousel-item">
		      <img src="../img/facilities/spa3.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
...
고상하고 순결한 에비앙 산의 이미지에서 영감을 얻은 자연 본연의 훼손되지 않은 휴식처입니다.<br>
고급스럽고 감각적인 소재, 자연채광과 환상적인 서울의 전망이 어우러진 럭셔리 스파.<br>
편안하고 여유로운 환경에서 프리미엄 수분공급이라는 독특한 경험을 제공해 드립니다.
        </div>
      </div>
      <div class="row text-center">
