		...
		<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" style="width:100%">
		  ...
		  <div class="carousel-inner" >
		    <div class="carousel-item active">
		      <img src="../img/food/bar1.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="../img/food/bar2.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
		    ...
		    <div class="carousel-item">
		      <img src="../img/food/bar3.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
    ...
    <div class="container">
       <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" id="room_name">[ 럭셔리 바 & 라운지 ]</h2>
          <h3 class="section-subheading text-muted">
			총 5개의 크고 작은 별실로 이루어진 고품격 프라이빗 바 & 라운지로서 비즈니스와 프라이버시를
			<br>
			중시하는 분들을 위한 독립된 공간입니다.
			<br>
			안락한 공간에서 위스키, 와인 등을 프라이빗하게 즐기실 수 있습니다.
			</h3>
        </div>
      </div>
      <div class="row text-center">
       ...
       <div class="row">
        <div class="col-lg-12 text-center">
				...
				<table class="rwd-table">
						...
						<tbody>
							<tr>
								<th scope="col">바 이용시간</th>
								<td><div class="td-txt">일~목요일 및 공휴일 18:00~01:00<br>금~토요일 18:00~02:00</div></td>
								<th scope="col">라운지 이용시간</th>
								<td><div class="td-txt">11:00~23:00</div></td>
							</tr>
							<tr>
								<th scope="col">바 문의전화</th>
								<td><div class="td-txt">Tel)xx-xxxx-xxxx</div></td>
								<th scope="col">라운지 문의전화</th>
								<td><div class="td-txt">Tel)yy-yyyy-yyyy</div></td>								
							</tr>
						</tbody>
				</table>
        </div>
