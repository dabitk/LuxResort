			...
			<td width='25%'>  			<!-- 로그인 여부에 따라 LOG IN 버튼 또는 LOG OUT 버튼이 보이게 한다 -->
  			<c:choose>
  				<c:when test="${sessionScope.login_ok eq 'yes_member' || sessionScope.login_ok eq 'yes'}">
		  			<a href="<%=request.getContextPath()%>/mobile/member_logout.jsp">
		  				LOG OUT
		  			</a>  				
  				</c:when>
  				<c:otherwise>
  					<a href="<%=request.getContextPath()%>/mobile/member_login.jsp">
		  				LOG IN
		  			</a>
  				</c:otherwise>
  			</c:choose></td>
			<td width='25%'><a href="<%=request.getContextPath()%>/mobile/member_register.jsp">REGISTER</a></td>
        ...
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item" style="min-width: 150px" id ="mkreservation" >
            <a class="nav-link js-scroll-trigger dropdown-toggle" id="dropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">예약하기</a>
	            ...
	            <a class="dropdown-item" href="<%=request.getContextPath()%>/mobile/d_01.jsp">예약 상황</a>
	            <div class="dropdown-divider"></div>
	            <a class="dropdown-item" href="<%=request.getContextPath()%>/mobile/d_02.jsp">객실 예약</a>
	            <div class="dropdown-divider"></div>
	            <c:choose>
  				<c:when test="${sessionScope.login_ok eq 'yes' }">
	            <a class="dropdown-item" href="<%=request.getContextPath()%>/mobile/admin_logout.jsp">관리자 로그아웃</a>			
  				</c:when>
  				<c:otherwise>
          ...
          <li class="nav-item" style="min-width: 150px" id="notice" >
            <a class="nav-link js-scroll-trigger dropdown-toggle" id="dropdown5" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">팬션소식</a>
	            ...
	            <a class="dropdown-item" href="<%=request.getContextPath()%>/mobile/e_01.jsp">공지사항</a>
	            <div class="dropdown-divider"></div>
	            <a class="dropdown-item" href="<%=request.getContextPath()%>/mobile/e_02.jsp">Q & A</a>
	          </div>            
          </li>
        </ul>    
      </div>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:100%">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="../img/room/r7.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="../img/room/standard1.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
		    ...
		    <div class="carousel-item">
		      <img src="../img/room/standard2.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
    ...
    <div class="container">
       <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" id="room_name">[ 프리미어 디럭스 ]</h2>
          <h3 class="section-subheading text-muted">
 산뜻한 스카이 블루와 따뜻한 온색계열의 색상을 테마로한 프리미어 디럭스룸은 고객님께서
 <br> 
 안락함과 상쾌한 경험을 하실 수 있도록 디자인 되어있습니다. 싱그러운 자연의 향기가 솔솔 풍겨오는 야외 발코니에서는
 <br>
 에메랄드 빛 바다와 제주의 일몰을 감상하며 먼 이국으로 떠나온 듯한 분위기를 만끽하실 수 있습니다.</h3>
        </div>
      </div>
      <div class="row text-center">
				...
				<table class="rwd-table">
						...
						<tbody>
							...
							<tr>
								...
								<td><div class="td-txt">침실 1, 거실 1, 욕실 1</div></td>
								<th scope="col">객실 면적</th>
								<td><div class="td-txt">55㎡</div></td>
							</tr>
							<tr>
