		...
		<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" style="width:100%">
		  ...
		  <div class="carousel-inner" >
		    <div class="carousel-item active">
		      <img src="../img/food/bakery1.jpg" style="width:100%">
		    ...
		    <div class="carousel-item">
		      <img src="../img/food/bakery2.jpg" style="width:100%">
		      <div class="carousel-caption">
		        <h3></h3>
		        <p></p>
		      </div>
    ...
    <div class="container">
       <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" id="room_name">[ Pastry Boutique ]</h2>
          <h3 class="section-subheading text-muted">
          품격있는 명품 쥬얼리 부티크를 연상시키는 디스플레이와 전문 파티시에의 손길에서 태어난
          <br>
          정성이 담긴 명품 패스트리와 베이커리를 만나보실 수 있습니다.
          <br>
          트렌디한 부티크를 콘셉트로 고급스러우 진열장에 정성껏 만든
          <br>
          케이크와 패스트리를 전시해 맛과 멋의 품격을 높였습니다.
          </h3>
        </div>
      </div>
      <div class="row text-center">
				...
				<table class="rwd-table">
						...
						<tbody>
							<tr>
								...
								<td><div class="td-txt">09:00~22:00</div></td>
								<th scope="col">타입</th>
								<td><div class="td-txt">베이커리</div></td>
							</tr>
							<tr>
								<th scope="col">추가정보</th>
								<td><div class="td-txt">트랜스 지방을 최소화한 유지류 및 유기농 밀가루만을 사용합니다.</div></td>
