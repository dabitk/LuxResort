...
<%
	...
	errorcode = bbs.makeReservation(name,checkin,room,addr,telnum,in_name,comment,write_date,processing);
      ...
      <div class="row">
		...
		<c:choose>
			...
			<%--errorcode가 0인 경우 (에러가 발생하지 않음)에는 이하 코드 실행--%>
				<div>
					<h1 align=center><b><%=checkin %>에 예약되셨습니다.</b></h1>
					<p align=center>5초뒤 리조트 홈페이지로 리다이렉트 됩니다.</p>
					<span>
						<a class="btn btn-primary btn-lg rippler rippler-inverse" href="d_01.jsp">예약현황 목록으로</a>
					</span>		
				</div>
			</c:when>
			<c:otherwise>
