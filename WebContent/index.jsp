            ...
            <form action="#">
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3 align-self-end">
                  <a href="d_01.jsp" class="btn btn-primary btn-block text-white">예약하러 가기</a>
                </div>
              </div>
            </form>
          </div>
...
<!-- 	<span class="main-reservationbar" style="position:relative; left:0; top:-200px;">
                 <form action="#" method="get" id="mainReservationBarForm" name="mainReservationBarForm">
                    <input type="hidden" name="resvCalDisplay" value="N"/>
                    <input type="hidden" name="hotelCode" value="LTSG" data-startdate="2020-01-09" data-enddate="2020-03-08"/>
                    <input type="hidden" name="primaryLangID" value="K"/>
                    <input type="hidden" name="langCode" value="ko"/>
                    <input type="hidden" name="reservationType" value="chain"/>
                    <fieldset>
				        <i class="far fa-building"></i> 호텔명 : <input type="text" name="st_name"/>
				        <i class="fal fa-table"></i> 체크인 : <input type="text" name="chck_in"/>
				        <i class="fal fa-table"></i> 체크아웃 : <input type="text" name="chck_out"/>
				        <i class="fal fa-male"></i> 인원수 : <input type="text" name="department"/>
